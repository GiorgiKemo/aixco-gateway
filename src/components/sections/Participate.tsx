      ...
      <div className="container-x">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {participationRoutes.map((r, i) => (
            <article key={r.id} className="group relative rounded-sm border border-border/60 bg-background p-8 md:p-10 transition-all hover:border-primary/60 hover:shadow-gold">
        ...
        <p className="mt-10 max-w-3xl text-xs leading-relaxed text-muted-foreground border border-border/40 rounded-sm p-4">
