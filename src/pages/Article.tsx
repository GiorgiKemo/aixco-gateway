      ...
      <main className="pt-28 pb-20">
        <article>
          ...
          <div className="container-x max-w-3xl py-16 md:py-24 space-y-7">
            {article.body.map((b, i) => {
              ...
              if (b.type === "stat") return (
                <div key={i} className="my-6 flex items-baseline gap-5 border-y border-border/60 py-6">
          ...
          <div className="container-x max-w-3xl border-t border-border/60 pt-10 pb-4">
            <Link to={`/insights/${next.slug}`} className="group flex items-center justify-between gap-6 rounded-sm border border-border/60 p-6 hover:border-primary/60 transition">
              <div>
