...
const dict: Dict = {
  ...
  "nav.about": { en: "About AIXCO", de: "Über AIXCO", ru: "О компании", ka: "AIXCO-ს შესახებ", tr: "Hakkımızda", ar: "عن أيكسكو" },
  "nav.aboutShort": { en: "About", de: "Über uns", ru: "О нас", ka: "ჩვენ შესახებ", tr: "Hakkımızda", ar: "عن الشركة" },
  ...
  "nav.participate": { en: "Ways to Participate", de: "Mitwirken", ru: "Участие", ka: "მონაწილეობა", tr: "Katılım Yolları", ar: "طرق المشاركة" },
  "nav.participateShort": { en: "Participate", de: "Mitwirken", ru: "Участие", ka: "მონაწილეობა", tr: "Katılım", ar: "المشاركة" },
  "nav.how": { en: "How AIXCO Works", de: "So funktioniert AIXCO", ru: "Как работает AIXCO", ka: "როგორ მუშაობს", tr: "Nasıl Çalışır", ar: "كيف نعمل" },
  "nav.howShort": { en: "How it Works", de: "Ablauf", ru: "Как это работает", ka: "როგორ მუშაობს", tr: "Nasıl Çalışır", ar: "كيف نعمل" },
  ...
  "nav.projects": { en: "Projects", de: "Projekte", ru: "Проекты", ka: "პროექტები", tr: "Projeler", ar: "المشاريع" },
  "nav.company": { en: "Company", de: "Unternehmen", ru: "Компания", ka: "კომპანია", tr: "Şirket", ar: "الشركة" },
  "nav.resources": { en: "Resources", de: "Ressourcen", ru: "Ресурсы", ka: "რესურსები", tr: "Kaynaklar", ar: "الموارد" },
