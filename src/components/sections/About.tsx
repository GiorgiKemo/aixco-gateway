    ...
    <section id="about" className="relative py-28 md:py-36 scroll-mt-24">
      ...
      <div className="container-x grid gap-16 lg:grid-cols-12">
        <div className="lg:col-span-5 lg:sticky lg:top-28 self-start">
          ...
          <div className="mt-8 overflow-hidden rounded-sm border border-border/60">
            <img src={architecture} alt="Cinematic architectural detail of a luxury skyscraper facade with golden light" loading="lazy" className="w-full h-72 object-cover" width={1024} height={1024}/>
          </div>
        </div>
