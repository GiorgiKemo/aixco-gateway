  ...
  return (
    <section id="how" className="relative py-28 md:py-36 scroll-mt-24">
      <div className="container-x">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-px bg-border/60 rounded-sm overflow-hidden">
          {journeys.map((j, i) => (
            <button
              key={j.role}
              onClick={() => openJourney(j)}
              className="group bg-background p-7 text-left transition-colors hover:bg-surface-elevated min-h-[260px] flex flex-col justify-between"
            >
              <div>
